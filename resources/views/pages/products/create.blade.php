            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" cols="30" rows="10" class="form-control @error('description') is-invalid @enderror" value="{{old('description')}}"
                        ></textarea>
                        @error('description')
                            <span class="invalid-feedback">{{$message}}</span>
                        @enderror
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-sm btn-primary"><i class="mr-2 fas fa-save"></i>Simpan</button>
                    </div>
                </div>
            </div>
        </form>
